...
Note that if you score dataset 0 there are only 3 TCs, so cases 4 to 10 will come up as ERROR. 

ECOO Finals, 2016. Written by Sam Scott (sam.scott@sheridancollege.ca)"""
